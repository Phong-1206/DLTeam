        ...
        <div class="w-full lg:w-1/2">
            <div class="lg:max-w-lg">
                ...
                <div class="grid gap-6 mt-8 sm:grid-cols-2">
                    ...
                    <div class="flex items-center text-gray-800 -px-3 dark:text-gray-200">
                        <svg class="w-5 h-5 mx-3 text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
...
<div class="container py-10 mx-auto lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
    <h1 class="text-3xl font-semibold dark:text-white text-center">Download Now</h1>
